                ...
                {blogs.map((blog) => (
                    ...
                    >
                        <Image
                            ...
                            alt={blog.title}
                            className="w-full lg:w-1/2 h-64 lg:h-[350px] object-cover rounded-xl"
                            width={600} // Approximate width for lg:w-1/2 in max-w-6xl
                            height={350} // Matches lg:h-[350px]
                        />
                        <div className="flex flex-col justify-between w-full lg:w-1/2">
                            <div>
                                <div className="flex items-center gap-2">
                                ...
                                <h3 className="text-xl sm:text-2xl font-bold text-[#232536] mt-4 leading-tight">
                                    {blog.title}
                                </h3>
                                <p className="text-sm sm:text-base text-[#232536] mt-4 capitalize leading-[24px]">
                                    {blog.content.slice(0, 200)}...
